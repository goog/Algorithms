...
class Genetic:
    ...
    def crossover(self):
        ...
        for i in range(cross_num/2):
            ...
            if fitness_list_prior[1]<fitness_list[0]:
                continue
    ...
    def newbee(self):
        ...
        # notice here ... here the smaller the fitness ,the better
    ...
    def fitness(self,numList):
        ...
        x1,x2= -65.536+0.001*int(''.join(map(str,xl)),2),-65.536+0.001*int(''.join(map(str,yl)),2)
        return shekel(x1,x2)
