...
class LogisticRegression(object):
    ...
    def __init__(self, input, n_in, n_out):
        ...
        # compute the predicted class label for each example whose probability is maximal in symbolic form
    ...
    def negative_log_likelihood(self, y):
        ...
        :param y: a vector, the correct labels
        ...
        # with one row per example and one column per predicted class
...
def load_data(dataset):
    ...
    # target is a numpy.ndarray of 1 dimensions (vector)) that have the same length as
    #the number of rows in the input. It should give the target to the example with the same index in the input.
